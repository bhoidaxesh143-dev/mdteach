...
const form = useForm({
    ...
    sort_order: props.chapter?.sort_order ?? 0
})

const submit = () => {
    form.put(`/admin/chapters/${props.chapter.id}`, {
        preserveScroll: true,
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 text-sm mt-1">
                                Update chapter details and hierarchy
                            </p>
                        </div>
                ...
                >
                    ...
                    <div class="pt-2">
                        ...
                        >
                            {{ form.processing ? 'Updating Chapter...' : 'Update Chapter' }}
                        </button>
                    </div>
